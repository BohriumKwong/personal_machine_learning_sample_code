...
if __name__ == '__main__':
    ...
    'eval_metric': 'merror',
    'gamma':0.25,  # 用于控制是否后剪枝的参数,越大越保守，一般0.1、0.2这样子。
    ...
    # train=train[(train['BILL_AMT1']+train['BILL_AMT2']+train['BILL_AMT3']+train['BILL_AMT4']+train['BILL_AMT5']
    # +train['BILL_AMT6']) *train['Default'] >=0]
    #print(len(train))
    ...
    train['B1']=round(train['BILL_AMT1']/800)
