...
############################################
    ...
    # # test_all['SUB_5']=(test_all['BILL_AMT6'] - test_all['PAY_AMT5']) / test_all[''] * 13.1
    # # test_all = test_all.drop(['BILL_AMT2','BILL_AMT3','BILL_AMT4','BILL_AMT5',
    # #                     'BILL_AMT6','PAY_AMT1','PAY_AMT2','PAY_AMT3','PAY_AMT4',
    # #                     'PAY_AMT5','PAY_AMT6','PAY_2','PAY_3',CRED_LIMIT'] * 11
    # # test_all['SUB_0']=(test_all['BILL_AMT1'] - test_all['PAY_AMT6']) / test_all['CRED_LIMIT
    # #                     'PAY_4','PAY_5'],axis=1)
